...
//  property, write a function that returns a new array containing the names of all people who
...
const emptypeople= []   
    for (let i = 0; i <= people.length; i++) {
        if(i>=18){
         ...
         return emptypeople.push([i]) 
    }
    i++   
   
if(people.age>=18){
    return n.name+people.age
}
}
...
// // ];
// let products={
//     name:"laptop","Shirt","Haedphones","Shoes"
//     price:1200, 25,80,60
//     introduce:function(){
//         console.log("Hello");
//         console.log(`Helintroduce:function(){lo my name is ${this.name}`);
//     }
// let product="Shirt",
// price=, 25,
// category:function(){
...
// //  scores, write a function that returns a new array containing the names of all students whose average
